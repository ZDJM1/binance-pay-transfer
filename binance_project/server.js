...
// Binance Pay Transfer System - Node.js + Express + MongoDB + Frontend
...
// Binance API Credentials (store securely)
const API_KEY = process.env.BINANCE_API_KEY;
const API_SECRET = process.env.BINANCE_API_SECRET;

// Function to generate Binance Pay signature
...
// Transfer funds endpoint (only for logged-in users)
